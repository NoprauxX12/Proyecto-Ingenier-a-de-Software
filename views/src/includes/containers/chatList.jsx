...
// notificacion  <div style={{width: "1.5em", height: "1.5em", borderRadius: "50%", backgroundColor: "#55ACEE", marginLeft: "2.3em", textAlign: "center"}}><p style={{color: "#fff", fontWeight: "bold"}}>1</p></div>